...
class HandlerAllText(Handler):
    ...
    def pressed_btn_up(self, message):
        ...
        # получаем количество конкретной позиции продуктов
    ...
    def pressed_btn_x(self, message):
        ...
        if count.__len__() > 0:
            ...
            # если товра нет в заказе отправляем сообщение
    ...
    def pressed_btn_back_step(self, message):
        """
        Обрабатывает нажатия кнопки перемещения
    ...
    def pressed_btn_applay(self, message):
        ...
        self.bot.send_message(message.chat.id,
                              MESSAGES['applay'].format(
                                  utility.get_total_coast(self.BD),
    ...
    def handle(self):
        ...
        def handle(message):
            ...
            # Меню (категории товара, ПФ, Бакалея, Мороженное #
            ...
            # иные нажатия и ввод данных пользователя
            else:
