# импортируем специальные типы телеграмм бота для создания элементов
# интерфейса
...
class Keyboards:
    """
    Класс предназначен для создания и разметки интерфеса бота
    """
    ...
    def start_menu(self):
        """
        Создаем разметку кнопок в основном меню и возвращает разметку
        """
    ...
    def set_select_category(self, category):
        ...
        категории товара и возварщает разметку
        """
        self.markup = InlineKeyboardMarkup(row_width=1)
        # загружаем в названия инлайн-кнопок данные
        # из БД в соответсвие с категорией товара
