...
class Singelton(type):
    """
    Патерн Singelton предоставляет механизм создания одного
...
class DBManager(metaclass=Singelton):
    """
    ...
    def select_all_product_id(self):
        """
        Возвращает все id товара заказа
        """
    ...
    def update_order_value(self, product_id, name, value):
        ...
        в соответсвии с номером товара -rownum
        """
    ...
    def count_rows_order(self):
        """
        Возвращает количество позиций в заказ
        """
